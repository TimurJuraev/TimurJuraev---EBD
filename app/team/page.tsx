  ...
  const teamMembers = [
    {
      ...
      email: 'tjuraev@excelia-bd.com',
      contact: '+44 (0) 754 2838 158',
      linkedin: 'https://www.linkedin.com/in/tjuraev/',
      expertise: 'High quality Analytics and Financial Modelling deliverables in the audit of UK TIER 1 banks and top AWM firms.',
      image: '/timur-juraev.jpg'
    },
    {
      name: 'Khusan Raymjonov',
      title: 'Co-Founder and CFO',
      email: 'kraymjonov@excelia-bd.com',
      contact: '+44 (0) 781 0582 954',
      linkedin: 'https://www.linkedin.com/in/khusan-r-8ab72310b/',
      expertise: 'Internal controls enhancement, Delivered multiple external audit projects for FTSE 100 companies',
      ...
      <section className="bg-gradient-to-r from-[#0B3C5D] to-[#328CC1] py-20 px-4">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            >
              Meet the experts behind EXCELIA BUSINESS DYNAMICS, bringing decades of 
              experience in analytics, business transformation, and industry expertise.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our leadership team combines deep industry knowledge, technical expertise, and a 
              passionate commitment to delivering transformative solutions for our clients.
            </p>
          </motion.div>
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-[#0B3C5D] font-medium mb-4">{member.title}</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our organization is structured to deliver maximum value to our clients,
              with specialized teams focused on specific domains and technologies.
            </p>
          </motion.div>
          ...
          >
            <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
              <div className="flex flex-col items-center p-6 border-b border-gray-200">
                ...
                <p className="text-sm text-muted-foreground">Strategic direction and executive oversight</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-center text-muted-foreground">Data scientists and business analysts</p>
                </div>
                ...
                <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-center text-muted-foreground">Engineers and architects</p>
                </div>
                ...
                <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-center text-muted-foreground">Domain experts and solution consultants</p>
                </div>
              </div>
              ...
              <p className="text-center mt-4 text-muted-foreground">
                Our client-centric structure ensures all teams collaborate seamlessly to deliver integrated solutions.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Strategically positioned in key financial centers to serve our global client base.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="relative h-[300px]">
                <Image 
                  src="https://images.pexels.com/photos/18923031/pexels-photo-18923031.jpeg"
              ...
              <div className="p-6 bg-white">
                ...
                <div className="space-y-3">
                  <p className="flex items-start">
                    <MapPin className="h-5 w-5 text-[#328CC1] mr-3 shrink-0 mt-1" />
                    International Business Center, Amir Temur Avenue, Tashkent, Uzbekistan
                  </p>
                  <p className="flex items-center">
                    <Phone className="h-5 w-5 text-[#328CC1] mr-3" />
                    +998 71 123 4567
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-white/90 max-w-xl">
                Be part of a dynamic team solving complex business challenges with innovative solutions.
              </p>
            </div>
            <Button 
