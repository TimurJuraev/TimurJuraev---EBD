  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    try {
      ...
      await sendEmail({
        ...
        cc_email: 'tjuraev@excelia-bd.com',
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    <SelectItem value="analytics-modeling">Analytics, Modeling & Automation</SelectItem>
                                    <SelectItem value="business-process">Business Process Enhancement</SelectItem>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@excelia-bd.com" className="text-white/80 hover:text-white transition-colors">
                          info@excelia-bd.com
                        </a>
                      </div>
                    </div>
