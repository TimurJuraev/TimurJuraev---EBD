      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative mx-auto max-w-4xl rounded-xl overflow-hidden shadow-2xl">
          ...
          <img
            ...
            alt="EXCELIA Intelligence Platform Preview"
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Join our exclusive early access program and be the first to experience the EXCELIA Intelligence Platform.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        We'll notify you when the platform is available.
                      </p>
                    </div>
