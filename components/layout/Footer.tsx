        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold">
                ...
                <span className="text-[#228B22]">IA</span>
                <span className="text-white"> Business Dynamics</span>
              </h3>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/analytics-modeling-and-automation" className="text-gray-300 hover:text-white transition-colors">
                  Analytics, Modeling & Automation
                </Link>
              </li>
              <li>
                <Link href="/services/business-process-enhancement" className="text-gray-300 hover:text-white transition-colors">
                  Business Process Enhancement
                </Link>
              </li>
              <li>
                <Link href="/services/digital-transformation" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <a href="mailto:info@excelia-bd.com" className="text-gray-300 hover:text-white transition-colors">
                info@excelia-bd.com
              </a>
            </div>
            <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} EXCELIA BUSINESS DYNAMICS. All rights reserved.
            </p>
